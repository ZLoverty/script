...
DESCRIPTION
===========
This script apply mask on PIV data. It sets all the irrelevant (x, y in the False region of the mask) PIV velocity to np.nan.
...
NOTE
====
1. The original PIV data will be overwritten, since they are no longer useful.

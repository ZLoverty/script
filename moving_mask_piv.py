...
In short, the job is done in 3 steps:
1. determine droplet trajectory
2. generate cropped images
3. perform normal PIV on cropped images
For more information, see the note "Notes\2022-03-02_moving-mask-droplet-frame-piv.pdf"
...
x0, y0, maskw, maskh: initial mask information, for computing the offset of the trajectory.
                        Can be read from positions.csv file.
